  ...
  return (
    <Float speed={1.75} floatIntensity={2} rotationIntensity={1}>
      ...
      <mesh castShadow receiveShadow scale={2.75}>
        ...
        <meshStandardMaterial color="#dadada" polygonOffset polygonOffsetFactor={-5} flatShading />
...
const BallCanvas = ({ icon }) => {
  return (
    <Canvas className="tech-cont_ball" frameLoop="demand" gl={{ preserveDrawingBuffer: true }}>
